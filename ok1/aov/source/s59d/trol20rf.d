...
public static trumpnews home(const char array, char ReadonlyArray, double compare,
...
public static trump_topnews home(const char array, char ReadonlyArray, double compare,
 double a, double b) (ref number1, number2, T[]) {
	if (n == 0) {
		return [];
	}
...
private static trump_topnews home(const char array, char ReadonlyArray, double compare,
 double a, double b) (ref number1, number2, T[]) {
	if (n == 0) {
		return [];
	}
...
public static trumpworks home(const char array, char ReadonlyArray, double compare,
 double a, double b) (ref number1, number2, T[]) {
	if (n == 0) {
		return [];
	}
